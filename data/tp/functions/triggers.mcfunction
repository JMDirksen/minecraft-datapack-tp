...
execute as @a[scores={tp-home=1..,tp-home-y=1..,tp-tokens=1..,tp-cooldown=0}] run tellraw @s ["",{"text":"Teleported home","color":"green"}]
...
execute as @a[scores={tp-spawn=1..,tp-tokens=1..,tp-cooldown=0}] run tellraw @s ["",{"text":"Teleported to spawn","color":"green"}]
...
execute as @a[scores={tp-random=1..,tp-tokens=1..,tp-cooldown=0}] run tellraw @s ["",{"text":"Teleported to a random location","color":"green"}]
